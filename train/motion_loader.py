"""Torch reference motion loader for Isaac Lab vectorized environments."""
...
class GenLocoMotionLoader:
    ...
    def _apply_cycle_offsets(
        ...
        if self.enable_cycle_offset_rot:
            ...
            # Pacing motions currently do not use rotation offsets. Keep
            # velocities unchanged rather than introducing an approximate rotate.
